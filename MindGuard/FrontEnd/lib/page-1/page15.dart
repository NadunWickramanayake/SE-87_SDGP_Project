    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroupk3shtp3 (4eeoE5bBYXsaqSJyznK3sH)
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // img20221225wa00182Tkf (74:95)
                    width: 66*fem,
                    height: 66*fem,
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(250*fem),
                      child: Image.asset(
                        'assets/page-1/images/img-20221225-wa0018-2-ZxP.png',
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
            ...
            Container(
              // autogroupp1b97yd (4eeowPjgJ92B8DAotfP1b9)
              ...
              child: Column(
                ...
                children: [
                  Container(
                    // autogroupivw5RjR (4eeoRKmSrUvjwAvXdEivw5)
                  ...
                  Container(
                    // autogroupxq2tVWK (4eeoauKpVFgFAedYnoxq2T)
                    ...
                    child: Center(
                      // callanemergencycontactnumberjv (77:19)
                      child: SizedBox(
                        child: Container(
                          constraints: BoxConstraints (
                            maxWidth: 218*fem,
                  ...
                  Container(
                    // autogroupulzoLBV (4eeoijS7APWQwTVDZxULzo)
