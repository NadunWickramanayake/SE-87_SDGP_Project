    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroupfkdyde3 (5NR8ySGkfD5VrJ2ewzFkDY)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // autogroupjvwp6Gj (5NR93mUsR54zhmBcxHJVwp)
                    ...
                    child: Stack(
                      children: [
                        Positioned(
                          ...
                          child: Align(
                            child: SizedBox(
                              ...
                              height: 47.42*fem,
                              child: Image.asset(
                                'assets/page-1/images/chevron-left-XjZ.png',
                                fit: BoxFit.contain,
                              ),
                            ),
                          ),
                        ...
                        Positioned(
                          // continuequestionnairesgo (83:31)
                          left: 28*fem,
                          top: 10*fem,
                          child: Align(
                            child: SizedBox(
                  ...
                  Container(
                    // img20221225wa00182udV (74:41)
                    width: 66*fem,
                    height: 66*fem,
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(250*fem),
                      child: Image.asset(
                        'assets/page-1/images/img-20221225-wa0018-2-xh9.png',
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
            ...
            Container(
              // autogrouppss4bmD (5NR98mLYSbyxJXuCLvpSs4)
